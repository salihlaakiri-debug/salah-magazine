  ...
  return (
    <section className="relative min-h-[80vh] flex items-center justify-center hero-gradient overflow-hidden">
      <div className="absolute inset-0 pointer-events-none overflow-hidden hidden sm:block">
        ...
        <div className="absolute top-[25%] left-[15%] text-[20vw] font-[var(--font-heading)] font-bold text-stroke opacity-[0.03] select-none leading-none animate-gentle-pulse" aria-hidden="true">
          ٤
        </div>
      ...
      <div className="relative z-10 text-center px-4 sm:px-6">
        <h1
          className="text-[8rem] sm:text-[10rem] lg:text-[12rem] font-black font-[var(--font-heading)] leading-none mb-4 animate-fade-in-up"
          style={{
        ...
        <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold font-[var(--font-heading)] mb-3 animate-fade-in-up delay-100 opacity-0">
          الصفحة غير موجودة
        </h2>

        <p className="text-text-muted text-sm sm:text-base mb-8 sm:mb-10 animate-fade-in-up delay-200 opacity-0">
