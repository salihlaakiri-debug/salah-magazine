...
ولهذا لم يكن هناك شيء يدعو للغرابة بقدر التساؤل، حتى بدا لي وبشكل هادئ قانونٌ كوني يسقط امامي. عندها، لم تعد المشكلة في الكلمات. بل في سهولة تكرارها.. بربك! الكلمات تُستنسخ؟ الايقاع.. وكيف؟', 'يا ترى أي جزءٍ من الواقع كنتُ أضيفه إليه من عندي حتى بدا مختلفاً؟ مجرد كلمة مضطربة. تفترض وجود ثالث!', 'نثر', 'صلاح', 'published', '8 دقائق', NOW(), '2026-07-25'),
...
ثم سكتا. وعاد الصمت ليملأ المكان بينهما، ليس بصمتٍ يُخيف، بل بصمتٍ يُشبه ذلك النوع من الراحة التي لا نحتاج إلى تفسير لها.', 'جلسا على طاولةٍ لم تَرَ قط كوباً يحتوي على محتوى واحد... كان الصمت بينهما يُشبه نوعاً من الراحة.', 'قصة', 'صلاح', 'published', '4 دقائق', NOW(), '2026-07-20'),
...
لا تسألوني عن صوتي. فصوتي ليس صوتاً. بل هو الغياب الذي يجعل الحضور ممكناً. أنا الصمت الذي قبل الصوت، والنوم الذي قبل الحلم.', 'أنا الأول. قبل أن يُولد أي حرف، كنتُ أنا. أنا الذي يسكن بين الهمزة والياء.', 'شعر', 'صلاح', 'published', '3 دقائق', NOW(), '2026-06-30'),
...
نحن لا نقرأ كلام المؤلف فحسب. بل نقرأ صمتَه، تردُّده، اختياراته فيما لم يقل. وهذه هي القراءة الأعمق: قراءة الغياب.', 'القراءة الفعلية ليست في النص. بل فيما حوله. في الفاصلة التي تأخرت، في الكلمة التي غابت.', 'مقالات', 'صلاح', 'published', '4 دقائق', NOW(), '2026-06-25'),
...
ربما كان هذا هو الدرس الذي يُعلّمُنا الماء: أن تحمل الذاكرة لا يعني أن تمشي بثقلها. بل أن تمشي بها كما يمشي النهر.. بهدوء، بانسياب، بلا ضجيج.', 'الماء يتذكر كل شيء. يتذكر الطريق الذي قطعه من الغيوم إلى النهر. لكنه يحمل ذاكرته بخفةٍ لا تُشبه إلا النسيان.', 'تأملات', 'صلاح', 'published', '3 دقائق', NOW(), '2026-06-20');
